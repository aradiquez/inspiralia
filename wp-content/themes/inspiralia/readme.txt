...
ABOUT THEME
===========
inspiralia is Responsive, Multa-Purpose, HTML5 / CSS3 Theme for (Desktop, tablet, mobile phone…)
inspiralia is Created with Twitter Bootstrap 3.3.2 Framework. inspiralia is a great design idea for
website of Creative inspiralia,ecommerce, Corporate, Corporation and more …
Create Outstanding Website or Blog in Minutes!. Awesome Design, Unique Concepts, inspiralia has static and fixed header feature. it’s developed with lots of care and love.

Theme has two, three, four footer layout feature.We focused on usability across various
devices, starting with smart phones.it is compatible with various devices. inspiralia is a
Cross-Browser Compatible theme that works on All leading web browsers. inspiralia is easy to use and
user friendly theme.
Powerful but simple inspiralia theme content customized through customizer. to make your site attractive it has two
widget sections first for “sidebar widget section” and second for “Footer widget section” .

To make your website in two column use sidebar widget section. to set custom menu in header set primary location. we added social media links to added your social links.It boasts of beautifully designed page sections , Home, Blog and Default Page Template(page with right sidebar), Page Full-Width, Page Left Sidebar. inspiralia theme has more advanced feature to make your site awesome like: it has header top bar dark & lite color feature. Theme compatible with woocommerce. inspiralia is a fully woocommerce compitable theme. inspiralia is translation ready theme with WPML compatible & Many More….
...
============================================
 * inspiralia is based on Underscores. All the files in the theme package are from Underscores, unless stated otherwise.
...
/***** product Image *****/
/***** First ad Images CCO by ayberkdemircan0 *****/
