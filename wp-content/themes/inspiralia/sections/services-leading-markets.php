...
<section class="inspiralia-section inspiralia-leading-market <?php echo ( count(get_ancestors( get_the_ID(), 'post', 'post_type' ) ) > 0 ? 'inspiralia-internal' : '' ) ?>" style="<?php echo add_background_when_need() ?>">
  <div class="row">
