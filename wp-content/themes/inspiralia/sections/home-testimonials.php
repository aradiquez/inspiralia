...
<?php } ?>
  <div id="testimonial" class="container">
    <?php
    $inspiralia_testimonials_category = get_cat_ID('Testimonials');
    $inspiralia_latest_loop = new WP_Query( array( 'post_type' => 'post', 'order' => 'DESC', 'ignore_sticky_posts' => true, 'category__in' => $inspiralia_testimonials_category ) ); if ( $inspiralia_latest_loop->have_posts() ) :
            ...
            <article class="large">
              ...
              <div class="inspiralia-testimonial-contact">
                ...
                <h5 class="inspiralia-testimonial-company-name">
                  <?php echo get_post_meta(get_the_ID(), "testimonials-box-company-name", true); ?><br/>
                </h5>
                <a href="http://<?php echo get_post_meta(get_the_ID(), "testimonials-box-company-url", true); ?>" target="_blank"><?php echo get_post_meta(get_the_ID(), "testimonials-box-company-url", true); ?>
                </a>
              </div>
            </article>
