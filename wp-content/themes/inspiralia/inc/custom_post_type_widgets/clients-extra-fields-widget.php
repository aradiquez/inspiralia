...
function inspiralia_register_clients_extra_fields_metabox() {
  ...
  $clients_extra_fields->add_field( array(
    'name'             => esc_html__( 'Markets Selector', 'cmb2' ),
    'desc'             => esc_html__( 'Markets relation', 'cmb2' ),
    'id'               => $prefix . 'market_id',
    'type'             => 'select',
  ...
  $clients_extra_fields->add_field( array(
    'name'             => esc_html__( 'Country Selector', 'cmb2' ),
    'desc'             => esc_html__( 'Country relation', 'cmb2' ),
