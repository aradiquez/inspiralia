<?php
/**
* Plugin Name: Masonry Grid Resize Builder
* Plugin URI: http://bearsthemes.com
* Description: This plugin is addon visual composer, which is developed by Bearsthemes Team for Visual Comporser, Woocommerce plugin.
* Version: 1.0.0
* Author: Bearsthemes
...
class bears_shortcodes
{
	...
	function include_scripts_admin()
	{
		...
		wp_enqueue_script( 'tbbs-script-admin', TBBS_JS . 'jquery.bears-shortcodes.admin.js', array( 'jquery' ) );
	...
	function include_scripts()
	{
		 ...
		 * Lib JS Dynamics
		 */
		wp_register_script( 'dynamics', TBBS_JS . 'dynamics.min.js', array() );
		 ...
		 * Lib JS Tbbs Plugin
		 */
		wp_enqueue_script( 'tbbs-script', TBBS_JS . 'jquery.bears-shortcodes.js', array( 'jquery', 'dynamics' ) );
